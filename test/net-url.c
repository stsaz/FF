...
void test_domain()
{
	xieq(1, ffurl_isdomain(FFSTR("cc1")));
	xieq(1, ffurl_isdomain(FFSTR("com")));
	xieq(2, ffurl_isdomain(FFSTR("a.c")));
	xieq(2, ffurl_isdomain(FFSTR("1.cc")));
	xieq(2, ffurl_isdomain(FFSTR("a.c-c")));
	xieq(2, ffurl_isdomain(FFSTR("a.1cc")));
	xieq(2, ffurl_isdomain(FFSTR("a.cc1")));
	...
	xieq(2, ffurl_isdomain(FFSTR("xn--asd.xn--p1ai")));
